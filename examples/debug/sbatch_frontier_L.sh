...
#SBATCH --output=slurm-mi250xL-%j.out
#SBATCH --error=slurm-mi250xL-%j.err
...
srun -N$SLURM_NNODES --ntasks-per-node=8 --cpus-per-task=7 --gpu-bind=closest --cpu-bind=cores python debug.py --res=64 --distributed
