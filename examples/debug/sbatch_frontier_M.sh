...
#SBATCH --output=slurm-mi250xM-%j.out
#SBATCH --error=slurm-mi250xM-%j.err
...
srun -N$SLURM_NNODES --ntasks-per-node=8 --cpus-per-task=7 --gpu-bind=closest python debug.py --res=32 --distributed